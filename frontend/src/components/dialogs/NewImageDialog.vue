        ...
        >
          ...
          <div>
            <v-checkbox
              v-model="isPublic"
              density="comfortable"
              label="Public Image (As soon as the image gets approved, it will be visible in the gallery for others to use. You may puzzle non-public images by sending the puzzle link to others regardless of this setting.)"
            />
          </div>
          <div>
            <v-checkbox
          ...
          <div>
            <v-checkbox
              ...
              density="comfortable"
              :label="aiDetected
                ? 'AI-generated Image (Cannot be unchecked.)'
                : 'AI-generated Image (Check this if the image was generated by an AI.)'"
            />
          </div>
...
const preview = async (blob: Blob): Promise<void> => {
  ...
  try {
    ...
    const detected = detectAiMarkers(text)
    isAiGenerated.value = detected
    aiDetected.value = detected
  } catch (e) {
    log.error(e)
