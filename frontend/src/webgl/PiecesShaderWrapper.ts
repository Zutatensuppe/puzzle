...
import { EncodedPieceIdx, PieceRotation } from '@common/Types'
import type { EncodedPiece, EncodedPieceShape, GameId } from '@common/Types'
...
export class PiecesShaderWrapper {
  ...
  /**
   * Update the puzzle image texture with a new frame (for GIF animation)
   */
